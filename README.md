...
public class JieGardenAction : IMaaCustomAction
{
    ...
    public int Find(IMaaContext context, int x, int y, int width, int height, string NodeName)
    {
        ...
        var find = () =>
        {
            ...
            {
                if (context.ColorMatch(162, 170, 159, 0, 62, 77, image, out detail, 0.87, detail.HitBox.X, detail.HitBox.Y, detail.HitBox.Width, detail.HitBox.Height) && detail?.HitBox != null)
                {
                    context.Click(detail.HitBox.X, detail.HitBox.Y);
                    i = 0;
                    return true;
